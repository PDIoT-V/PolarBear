package pdiot.v.polarbear.bluetooth;
...
import pdiot.v.polarbear.MainActivity;

import static pdiot.v.polarbear.utils.Utils.bytesToHex;
import pdiot.v.polarbear.utils.Utils;
import pdiot.v.polarbear.utils.Constants;
import pdiot.v.polarbear.utils.SpeckIntentFilters;
import pdiot.v.polarbear.utils.RESpeckPacketHandler;
import pdiot.v.polarbear.utils.ThingyPacketHandler;
    ...
    private void startInForeground() {
        ...
        if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.O) {
            ...
            Notification notification = new Notification.Builder(this)
                    .setContentTitle("RESpeck and Airspeck")
...
//        final IntentFilter intentFilterRESpeckIMUMode = SpeckIntentFilters.INSTANCE.getRESpeckIMUIntentFilter();
    ...
    private void connectToRESpeck() {
        ...
        }, throwable -> Log.e(TAG, "Error occured while listening to RESpeck connection state changes: " + throwable.getMessage()));
    ...
    private void connectToThingy() {
        ...
        String mThingyName = mThingyDevice.getName();
